...
$errors = 0;
    ...
    if($errors==0)
    {
        $sql = "INSERT INTO `inventory` (`item`, `description`, `quantity`, `price`) VALUES ('$name', '$description', '$quantity', '$price')";
...
<body>
    ...
    <main>
        <section>
         ...
         <form action="add_inventory.php" method="post" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
               <div>
