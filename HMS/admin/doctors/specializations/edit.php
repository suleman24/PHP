...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE `specialization` SET `name` = '$name' WHERE `id` = $id";
 
    $result = mysqli_query($conn, $sql);
 
    if ($result) {
       header("Location: ../../specializations.php?msg=Updated successfully");
    } else {
         ...
         <form action="" method="post" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
               <div class="col">
                  ...
                  <input type="text" class="form-control" name="specialization_name" value="<?php echo $name ?>" >
               </div>
