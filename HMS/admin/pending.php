        ...
        <section>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <th style="width: 25%; align-items: end;"><button type="submit" class="btn btn-primary" style="margin-top: 30px; width: 40%"><a style="color: white;" href="specializations/specializations.php">Specializations</a></button></th>
                </tr>
...
FROM doctor
INNER JOIN specialization ON doctor.specialization_id = specialization.id WHERE doctor.status='0'";
        ...
        <a style= 'color:white'href='request_accept.php?id=" . $row["id"] . "' class='link-dark'>Accept
            <i class='fa-solid fa-pen-to-square fs-5 me-3'></i>
        </a>
    </button></td>
        <td>
        <button name='delete' style='background-color: white; color: red;' type='submit' class='btn btn-primary'>
        <a style= 'color:white'href='doctors/delete.php?id=" . $row["id"] . "' class='link-dark'>Delete
            <i class='fa-solid fa-pen-to-square fs-5 me-3'></i>
        </a>
    </button></td>
