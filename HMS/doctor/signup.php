...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($errors == 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO `doctor` (`fname`, `lname`, `age`, `username`, `password`, `specialization_id`, `fee`,`status`) 
          VALUES (?, ?, ?, ?, ?, ?,?)");


            $stmt->bind_param("ssisssii", $fname, $lname, $age, $username, $password, $specialization_id,$fee,$status);
...
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    ?>
        <div class="container form-group col-md-6 my-4">
            ...
            <form style="margin-bottom: 3%;" action="signup.php" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="fee" name="fee" aria-describedby="lnameHelp">
                </div>
                <?php
                ...
                <button style="margin-top: 3%;" type="submit" class="btn btn-primary form-group center-align">Sign up</button>
            </form>
